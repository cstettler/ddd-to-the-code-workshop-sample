...
public class WalletService {
    ...
    public void initializeWallet(WalletOwner walletOwner) throws WalletAlreadyExistsException {
        Wallet wallet = newWallet(walletOwner, this.domainEventPublisher);

        this.walletRepository.add(wallet);
    }

    public void billBookingFee(Booking booking) throws BookingAlreadyBilledException {
        Wallet wallet = this.walletRepository.get(booking.walletOwner());
